...
def automorphism_orbits(edge_list, print_msgs=True, **kwargs):
    ...
    gt_gen.remove_self_loops(graph)
    gt_gen.remove_parallel_edges(graph)
...
def subgraph_isomorphism_vertex_counts(edge_index, **kwargs):
    ...
    gt_gen.remove_self_loops(G_gt)
    gt_gen.remove_parallel_edges(G_gt)  
...
def edge_automorphism_orbits(edge_list, **kwargs):
    ...
    gt_gen.remove_self_loops(line_graph)
    gt_gen.remove_parallel_edges(line_graph)  
